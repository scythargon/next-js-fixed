...
module.exports = function (context) {
  ...
  return {
    ...
    plugins: [require('babel-plugin-react-require'), require('@babel/plugin-syntax-dynamic-import'), require('./plugins/react-loadable-plugin'), require('./plugins/next-to-next-server'), [require('@babel/plugin-proposal-class-properties'), opts['class-properties'] || {}], require('@babel/plugin-proposal-object-rest-spread'), [require('@babel/plugin-transform-runtime'), (0, _objectSpread2.default)({
      helpers: false,
      regenerator: true
    }, opts['transform-runtime'])], [process.env.NODE_ENV === 'test' ? require('styled-jsx/babel-test') : require('styled-jsx/babel'), styledJsxOptions(opts['styled-jsx'])], process.env.NODE_ENV === 'production' && require('babel-plugin-transform-react-remove-prop-types')].filter(Boolean)
  };
};