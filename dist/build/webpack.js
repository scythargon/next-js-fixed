...
function externalsConfig(dir, isServer) {
  ...
  var notExternalModules = ['next/app', 'next/document', 'next/error', 'http-status', 'styled-jsx'];
...
function _getBaseWebpackConfig() {
  ...
  _regenerator.default.mark(function _callee3(dir, _ref2) {
    var _ref2$dev, dev, _ref2$isServer, isServer, buildId, config, pages, defaultLoaders, nodePathList, distDir, outputPath, pagesEntries, totalPages, clientEntries, resolveConfig, webpackMode, webpackConfig, originalEntry;

    return _regenerator.default.wrap(function _callee3$(_context3) {
      while (1) {
        switch (_context3.prev = _context3.next) {
          case 0:
            _ref2$dev = _ref2.dev, dev = _ref2$dev === void 0 ? false : _ref2$dev, _ref2$isServer = _ref2.isServer, isServer = _ref2$isServer === void 0 ? false : _ref2$isServer, buildId = _ref2.buildId, config = _ref2.config, pages = _ref2.pages;
            defaultLoaders = {
              babel: {
          ...
          case 7:
            ...
            clientEntries = !isServer ? (0, _defineProperty2.default)({
              ...
              'main.js': []
            }, _constants.CLIENT_STATIC_FILES_RUNTIME_MAIN, [_path.default.join(_constants2.NEXT_PROJECT_ROOT_DIST, 'client', dev ? "next-dev" : 'next')]) : {};
            resolveConfig = {
            ...
            webpackConfig = {
              ...
              new _chunkNamesPlugin.default(), !isServer && new _reactLoadablePlugin.ReactLoadablePlugin(), new _webpackbar.default({
                name: isServer ? 'server' : 'client'
              ...
              !dev && new _webpack.default.IgnorePlugin({
                ...
                checkContext: function checkContext(context) {
                  return context.indexOf(_constants2.NEXT_PROJECT_ROOT_DIST) !== -1;
                }
              ...
              }), isServer && new _pagesManifestPlugin.default(), !isServer && new _buildManifestPlugin.default(), !isServer && new _pagesPlugin.default(), isServer && new _nextjsSsrImport.default() // isServer && new NextJsSSRModuleCachePlugin({outputPath})
              ].filter(Boolean)
            };
